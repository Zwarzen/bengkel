<?php
  ...
  $guru=mysqli_query($koneksi, "SELECT * FROM tb_guru WHERE id_guru = '$id_guru'");
            ...
            <fieldset style = "padding: 10px;">
              ...
              <form method="post" action="action_update.php" style="padding: 10px;">
                ...
                <table>
                  ...
                  <tr>
                    <td>ID Guru</td>
                    <td><input type="text" name="id_guru" onkeyup="isi otomatis" value="<?php echo $row['id_guru']; ?>"></td>
                  </tr>
                  ...
                  <tr>
                    <td>Keterangan</td>
                    <td><input type="text" name="ket_guru" value="<?php echo $row['ket_guru']; ?>"></td>
                  </tr>
