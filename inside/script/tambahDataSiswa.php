        ...
        <div style="padding-bottom: 210px;">
            ...
            <fieldset style = "padding: 10px;">
			    ...
			    <table>
					...
					<form action = "data_siswa/simpan.php" method = "post">
			            <fieldset style = "padding: 10px;">
			              <div>
			                <label for = "id_siswa">ID Siswa</label>
			                  <input class = "form-control" type = "text" name = "id_siswa" id = "" required="true">
			              </div>
			              
			              <div>
			                <label for = "nama_siswa">Nama Siswa</label>
			                  <input class = "form-control" type = "text" name = "nama_siswa" id = "" required="true">
			              </div>
			              
			              <div>
			                <label for = "nama_ortu">Nama Ortu</label>
			                  <input class = "form-control" type = "text" name = "nama_ortu" id = "" required="true">
			              </div>
			              <div>
